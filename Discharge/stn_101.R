...
## stn.names(101,102) ## name files
## if(stn.no[i]=="101" & yr==2014) wlr.dat$Stage <- wlr.dat$Stage+0.075 ## add 7.5cm to stage for year 2014
## This needs to be verified with actual field data.
