...
hydout.csv <- paste(hyd.dir, "wlr_102_tbrg_102_15min.csv", sep="")
hydout.pdf <- paste(hyd.dir, "wlr_102_tbrg_102_15min.pdf", sep="")
...
wlr<- read.csv("~/OngoingProjects/CWC/Data/Nilgiris/wlr/csv/wlr_102_discharge_onemin.csv")
...
hydout.csv <- paste(hyd.dir, "wlr_102_tbrg_101_15min.csv", sep="")
hydout.pdf <- paste(hyd.dir, "wlr_102_tbrg_101_15min.pdf", sep="")
## tbrg <- read.csv("/home/udumbu/rsb/OngoingProjects/CWC/Data/Aghnashini/tbrg/csv/tbrg_001_15 minutes.csv")
