...
anim.contour(z=cplot, times=1:20, speed=10, levels=80 + 1:12*10, lty=c(1,2,2))
anim.filled.contour(z=cplot, times=1:20, speed=30, levels=80 + 1:12*10,
...
theta=30, speed=1, border=NA, r=3, col="yellowgreen", shade=.5, box=FALSE)
