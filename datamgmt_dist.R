...
con <- dbConnect(PostgreSQL(), user= "", password="", dbname="cwc"); ## fix as per your setup
tbrgdatadir<-"" ## fix as per your setup.
wkdir<-"" ## fix as per your setup.
setwd(wkdir)
...
## Define the connection
con <- dbConnect(PostgreSQL(), user= "", password="", dbname="cwc");
