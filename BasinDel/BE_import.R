...
execGRASS("v.in.ogr", flags=c("o", "overwrite"),
          parameters=list(input=dsn, layer=contour.layer,output='soi_contours')
...
execGRASS("v.in.ogr",
          flags=c("o", "overwrite"),
          parameters=list(input=dsn, layer=stream.layer,output='tmp_stream')
          )
execGRASS("v.build",
          flags=c("e","overwrite", "verbose"),
...
execGRASS("v.in.ogr",
          flags=c("o", "overwrite"),
          parameters=list(input=dsn, layer=tbrg.layer,output='tmp_tbrg')
          )
execGRASS("v.in.ogr",
          flags=c("o", "overwrite"),
          parameters=list(input=dsn, layer=wlr.layer,output='tmp_wlr')
...
execGRASS("g.region", flags="p",
          parameters=list(vector='tmp_tbrg_hull_buffer', res='10')
