...
ratingdir <- "/home/udumbu/rsb/OngoingProjects/CWC/Data/Nilgiris/disch/csv"
disch.list <- list.files(path=dischdir, full.names=TRUE, recursive=FALSE, pattern="SD.csv$")
